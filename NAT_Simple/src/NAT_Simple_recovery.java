...
public class NAT_Simple_recovery {
    ...
    NAT_Simple_recovery(String host, int port){
        //this.host = host;
        //this.port = port;
    }
    ...
    private void sendMassage(String mes){
        try{
            ...
            while(!isExit){
                ...
                //------------------------------------------------------
                System.out.println("++++++++++++");
                System.out.println(Integer.toHexString(Res_type_message));
                //System.out.println(Res_type_message);
                System.out.println(Res_length_message);
                System.out.println(Integer.toHexString(Res_magic_cookie));
                System.out.println("TranslationID");
                for (int i =0;i<3;i++){
                    System.out.println(Res_translationID[i]);
                }
                ...
                {    
                    System.out.println(Res_atribute_type);
                }
                System.out.println("Port:");
                System.out.println(Res_port);
                System.out.println("IP:");
                for (int i = 0; i < 4; i++){
                    System.out.print(Res_IP[i]);
                    System.out.print(".");
                }
                System.out.println();
                //System.out.println();
    ...
    public static void main(String[] args) {
        ...
        try{
            while (strin!="exit"){
                ...
                strin = br.readLine();
                NAT_Simple_recovery sndr = new NAT_Simple_recovery("stun.1und1.de", 3478);
